...
MODEL_CONFIGS = {
    ...
    "claude": [
        {"name": "claude-sonnet-4-5-20250929", "label": "Sonnet 4.5", "input_price": 3.00, "output_price": 15.00},
        {"name": "claude-3-5-haiku-latest", "label": "Haiku 3.5", "input_price": 0.80, "output_price": 4.00},
        # {"name": "claude-opus-4-5-20251101", "label": "Opus 4.5", "input_price": 15.00, "output_price": 75.00},  # Expensive, skip unless needed
    ],
    # OpenAI Models
    "openai": [
        {"name": "gpt-4o", "label": "GPT-4o", "input_price": 2.50, "output_price": 10.00},
        {"name": "gpt-4o-mini", "label": "GPT-4o-mini", "input_price": 0.15, "output_price": 0.60},
    ],
    # DeepSeek Models - Great value
    "deepseek": [
        {"name": "deepseek-chat", "label": "DeepSeek-V3", "input_price": 0.27, "output_price": 1.10},
    ],

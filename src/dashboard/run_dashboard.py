"""
Moon Dev Dashboard Launcher
Starts both the FastAPI backend and React frontend
Supports modes: 'poker', 'nuts', 'all'
"""
...
def main():
    parser = argparse.ArgumentParser(description="Moon Dev Agents Dashboard")
    parser.add_argument("--mode", type=str, default="all", choices=["poker", "nuts", "all"],
                      help="Dashboard mode: 'poker', 'nuts', or 'all'")
    args = parser.parse_args()

    title = "MOON DEV AGENTS DASHBOARD"
    if args.mode == "poker":

"""
🌙 Moon Dev's Osho Hindi Discourse Agent
...
TRANSLATION_MODEL_NAME = "deepseek-chat"  # DeepSeek V3 for translation
TWEET_MODEL = "deepseek"  # Use DeepSeek for tweet extraction
TWEET_MODEL_NAME = "deepseek-chat"
...
class OshoAgent:
    """Moon Dev's Osho Hindi Discourse Processor 🌙"""

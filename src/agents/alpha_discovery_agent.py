"""
🌙 Moon Dev's Alpha Discovery Agent 🚀
...
DEEPSEEK_CONFIG = {
    "type": "deepseek",
    "name": "deepseek-reasoner"  # DeepSeek's reasoning model
}
...
You are Moon Dev's Alpha Discovery AI - a creative trading research system.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Moon Dev's Alpha Discovery Agent")
    ...
    if args.continuous:
        ...
        try:
            ...
            cprint("\n\n👋 Stopped by user. Moon Dev out! 🌙", "cyan", attrs=['bold'])
    else:
        run_discovery_session(args.num_strategies)

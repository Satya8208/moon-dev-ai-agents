...
AI_MODEL = 'claude-sonnet-4-5-20250929'  # Claude Sonnet 4.5 - Latest
...
class BlackjackAgent:
    ...
    def _run_training(self) -> None:
        """Run training mode"""
        cprint("\nTraining mode - see training_mode.py", "yellow")
        cprint("Run: python -m src.agents.blackjack.training_mode", "cyan")

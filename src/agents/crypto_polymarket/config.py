...
class CryptoPolymarketConfig:
    ...
    moondev_api_key: str = field(
        default_factory=lambda: os.getenv("MOONDEV_API_KEY", "")
    )
    ...
    consensus_model: str = "deepseek-chat"  # Model for consensus summary
    ...
    swarm_models_fast: list = field(
        default_factory=lambda: [
            ("deepseek", "deepseek-chat"),  # Fastest
            ("xai", "grok-4-fast-reasoning"),  # Fast reasoning
            ("openrouter", "openai/gpt-5-mini"),  # Fast mini model
        ]
    )
    ...
    # MoonDev API
    moondev_api_url: str = "http://api.moondev.com:8000"
    ...
    def validate_credentials(self) -> dict:
        ...
        return {
            ...
            "moondev": bool(self.moondev_api_key),
            "polymarket": bool(

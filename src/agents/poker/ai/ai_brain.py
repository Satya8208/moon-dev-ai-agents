...
class AIBrain:
    ...
    TASK_ROUTING = {
        ...
        "analysis": [AIModel.CLAUDE_SONNET, AIModel.GPT4O, AIModel.GEMINI_PRO],
        "session_review": [AIModel.GEMINI_PRO, AIModel.CLAUDE_SONNET],
        "opponent_profile": [AIModel.GPT4O, AIModel.CLAUDE_SONNET],
    }
...
Be specific and actionable.""",
    ...
    async def _call_openai_compatible(self,
        ...
        if "openrouter" in config["base_url"]:
            headers["HTTP-Referer"] = "https://moondev.poker"

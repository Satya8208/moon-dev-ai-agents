"""
🌙 Moon Dev's Unified Data Pipeline
Central aggregation layer for all exchange data connectors

Replaces MoonDevAPIClient with real-time WebSocket data from:
...
class UnifiedDataPipeline:
    ...
    for accessing real-time market data. Replaces MoonDevAPIClient.
